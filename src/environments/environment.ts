export const environment = {
  dataUrl: (endpoint: string, dimensionIndex: number) => dimensionIndex == 0 ? `https://letsplay.minecrafttransitrailway.com/system-map/mtr/api/map/${endpoint}?dimension=0` : `https://lps.gteh.top/datas/${dimensionIndex + 1}`,
  worldMapLink: {
    enable: (dimensionIndex: number) => true,
